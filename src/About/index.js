  ...
  render() {
    return (
      <div className="aboutContent">
        ...
        <p>I’m always looking for new and cool stuff to get my hands on, so if you have a great idea for a project, send me an email. I’ll be happy to give you some feedback and work together to create something awesome.</p>
