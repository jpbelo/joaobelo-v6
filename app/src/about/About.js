  ...
  render() {
    return (
      <div className="aboutContent">
        ...
        <p>I still make some stuff on the side, mainly with <a target="_blank" href="http://www.proto.pt">Proto</a> and <a target="_blank" href="http://manoamanoclub.com">Mano a Mano</a>, other two design studios in Porto.</p>
